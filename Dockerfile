...
CMD jupyter-lab --ip 0.0.0.0 --port 7860 --no-browser --allow-root --NotebookApp.token='mytoken' --NotebookApp.password='mypassword' --NotebookApp.allow_origin='*' --NotebookApp.headers='{"Content-Security-Policy": "frame-ancestors self huggingface.co hf.space camenduru-jupyter.hf.space huggingface.co/spaces/camenduru/jupyter"}'